...
if exists('g:exvim_custom_path')
    let vimrc_plugins_path = g:exvim_custom_path.'/.vim/vimrc.plugins'
    let vimrc_plugins_local_path = g:exvim_custom_path.'/.vim/vimrc.plugins.local'
else
...
nnoremap <S-Down> <C-W><Down> nnoremap <S-Left> <C-W><Left> nnoremap <S-Right> <C-W><Right>
...
if exists('g:exvim_custom_path')
    let vimrc_local_path = g:exvim_custom_path.'/.vim/vimrc.local'
endif
